...
#pragma once
#ifndef WAVETABLE_OSCILLATOR_SECTION_H
#define WAVETABLE_OSCILLATOR_SECTION_H
...
class WavetableOscillatorSection : public SynthSection {
  public:
    WavetableOscillatorSection(String name);
    ~WavetableOscillatorSection();
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(WavetableOscillatorSection)
};
