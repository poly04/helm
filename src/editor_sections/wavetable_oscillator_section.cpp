...
WavetableOscillatorSection::WavetableOscillatorSection(String name) : SynthSection(name) {
...
WavetableOscillatorSection::~WavetableOscillatorSection() {
...
void WavetableOscillatorSection::paintBackground(Graphics& g) {
...
void WavetableOscillatorSection::resized() {
...
void WavetableOscillatorSection::reset() {
